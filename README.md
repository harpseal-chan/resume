...
- チーム規模：　５名
- 使用言語：　C++
- 使用ツール:　Redmine, SVN, Visual Studio 2022
...
- 使用ツール:　FreeRTOS, Teraterm, SVN, VSCode

##### 業務内容詳細
- 以下の実装、結合テストを担当
  - 機器同士の接続、データ送受信、機器内のファイルとフォルダ削除
- Pythonで記述された既存機能のコードをC言語に書き換え
- Teratermマクロ, Python, バッチファイルで結合テストコードを作成
  - 40項目ほどテストを自動化
- 既存機能（コマンド）のコードを大幅にリファクタリング
...
#### Bluetoothの電波強度を用いた距離測定Androidアプリの機能改善・iOSアプリの開発（2020.12 - 2021.3）
