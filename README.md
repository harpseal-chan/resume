...
### 長所
- １度決めたことは最後までやり遂げる
  - 入社１年目に応用情報技術者の取得を目標にして、平日は2h、休日は7hほど勉強して１回目の受験で合格しました。
  - Webアプリを作成したいと思い、独学でフレームワークやインフラを習得してWebアプリを完成させました
...
- めんどくさがり
  - 楽をするための努力は怠らないです
  - 少しでも効率的に作業するために、ツールを使う際はまずショートカットキーを覚えます
  - 買い物は通販を駆使して、勉強に集中する時間を増やすようにしています
