...
- 実行コマンド解析のコードを大幅にリファクタリング

##### 得たスキル
- 組み込みC言語、Pythonの知識
- リアルタイムOSの基本的な知識

#### 3. Bluetoothの電波強度を用いた距離測定スマートフォンアプリの開発（2020.12 - 2021.3）
Bluetooth端末同士の距離を、電波強度（RSSI）から測定するスマートフォンアプリをAndroid版（Java）とiOS版（Swift）で開発
